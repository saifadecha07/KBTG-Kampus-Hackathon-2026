...
![Pace 3 หน้าจอหลัก: หน้าหลัก, ยืนยันเงินเข้า, กระเป๋านิรภัย](docs/05-prototype/flow.svg)

Mockup 3 หน้าจอ (หน้าหลัก → ยืนยันเงินเข้า → กระเป๋านิรภัย) ออกแบบด้วยภาษาการออกแบบใกล้เคียง K PLUS (สีแบรนด์เขียว KASIKORNBANK `#00A950` ซึ่งเป็นข้อมูลสาธารณะ — **ไม่ใช่ภาพหน้าจอจริงของแอป K PLUS**)

📄 อยากลองกดเอง (ปุ่ม "ขอถอน" จำลอง cooldown แบบเร่งเวลาได้จริง): [`docs/05-prototype/mockup.html`](docs/05-prototype/mockup.html) — ดาวน์โหลดแล้วเปิดในเบราว์เซอร์ (repo เป็น private จึงยังไม่มี live link แบบ GitHub Pages)

### ต้นไม้ในกระเป๋านิรภัยโตตามยอดจริง ไม่ใช่แค่ตกแต่ง

| ยอดคงเหลือในนิรภัย | ระยะต้นไม้ |
|---|---|
| 0 | ยังไม่ปลูก |
| 1 – 999 ฿ | หว่านเมล็ด |
| 1,000 – 4,999 ฿ | ต้นกล้า |
...
| 15,000 – 29,999 ฿ | ต้นโต |
| 30,000 – 49,999 ฿ | ใกล้เต็มต้น |
| ≥ 50,000 ฿ | เต็มต้น / ป่าเล็ก — ถึงเป้าเงินสำรอง 2–3 เดือน + เพดานดอกเบี้ยพิเศษพอดี |

คำนวณจากยอดคงเหลือปัจจุบัน (ถอนแล้วต้นเล็กลงตามจริง ไม่ใช่ค่าปรับ) เป็น visual ล้วนๆ ไม่กระทบ logic เงินใดๆ — รายละเอียดเต็มดู Decision R22 ใน [`decision_log.md`](docs/03-design/decision_log.md)
