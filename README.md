...
Mockup 3 หน้าจอ (หน้าหลัก → ยืนยันเงินเข้า → กระเป๋านิรภัย) — โทนสีมืด/เขียวมิ้นท์และองค์ประกอบ (ไอคอนวงกลม, การ์ดขาวลอยบนพื้นเข้ม, ปุ่มสแกนกลางแถบล่าง) อ้างอิงจากภาพตัวอย่างแอป K PLUS จริงบน App Store **ไม่ใช่ภาพหน้าจอจริงของแอป — เป็น concept ที่ทีมออกแบบเอง**
